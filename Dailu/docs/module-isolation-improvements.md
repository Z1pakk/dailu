...
- [ ] **`Dailu.Events` is the one shared-assembly exception to an otherwise
  ...
  exactly what buys extraction flexibility. `Dailu.Events` breaks that: every
...
- [ ] **Confirm module composition in `Dailu.Api/DependencyInjection.cs` is
