...
namespace HabitEntry.ArchitectureTests;

public class HabitEntryLayerTests
{
    private static readonly Assembly Domain = HabitEntry.Domain.AssemblyReference.Assembly;
    private static readonly Assembly Application = HabitEntry.Application.AssemblyReference.Assembly;
    private static readonly Assembly Api = HabitEntry.Api.AssemblyReference.Assembly;
    private static readonly Assembly Infrastructure = HabitEntry.Infrastructure.AssemblyReference.Assembly;
