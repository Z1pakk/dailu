...
namespace Habit.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260731131958_Habit_AddAutomationFilter")]
    partial class Habit_AddAutomationFilter
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Habit.Domain.Entities.HabitEntity", b =>
                {
                    ...
                    b.Property<string>("AutomationFilter")
                        .HasColumnType("text")
                        .HasColumnName("automation_filter");
